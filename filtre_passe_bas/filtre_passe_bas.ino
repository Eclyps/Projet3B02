...
float lowPassMag1_x, lowPassMag1_y, lowPassMag1_z;
float lowPassMag2_x, lowPassMag2_y, lowPassMag2_z;

// Variables pour le filtre Low-Pass
...
void loop() {
  ...
  lowPassMag1_x = lowPassFilter(mag1_x, lowPassMag1_x);
  lowPassMag1_y = lowPassFilter(mag1_y, lowPassMag1_y);
  lowPassMag1_z = lowPassFilter(mag1_z, lowPassMag1_z);

  lowPassMag2_x = lowPassFilter(mag2_x, lowPassMag2_x);
  lowPassMag2_y = lowPassFilter(mag2_y, lowPassMag2_y);
  lowPassMag2_z = lowPassFilter(mag2_z, lowPassMag2_z);
